...
//
{
    ...
    // ASSIGNMENT (PA02)
    //
    // Copy and modify the source for
    // PassthruShaderProgram::PassthruShaderProgram() to get the
    // vertex shader source from "constant_color_vertex_shader.glsl".
    // (The fragment shader source should be unchanged.)
    //
